...
urlpatterns = [
    ...
    path('materias/editar/<int:materia_id>/', views.MateriaUpdate.as_view(), name='atualizar_materia'),
    path('materias/deletar/<int:materia_id>/',views.MateriaDelete.as_view(), name='deletar_materia'),
    #views do curso
    ...
    path('materia/<int:materia_id>/editar_curso/<int:curso_id>/', views.CursoUpdate.as_view(), name='atualizar_curso'),
    path('materia/<int:materia_id>/deletar_curso/<int:curso_id>/',views.CursoDelete.as_view(), name='deletar_curso'),
    #views da aula
    ...
    path('materia/<int:materia_id>/<int:curso_id>/<int:aula_id>/editar_aula/', views.AulaUpdate.as_view(), name='atualizar_aula'),
    path('materia/<int:materia_id>/<int:curso_id>/<int:aula_id>/deletar_aula/',views.AulaDelete.as_view(), name='deletar_aula'),
    #views do evento
    ...
    #views inscricao
    path('eventos/inscricoes', views.InscricaoList, name='listagem_inscricoes'),
